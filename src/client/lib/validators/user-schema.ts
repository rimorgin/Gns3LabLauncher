...
export const validateUserEdit = (data: unknown) => {
  return userEditSchema.safeParse(data);
};

export const validateUserDb = (data: unknown) => {
  return userDbSchema.safeParse(data);
};
